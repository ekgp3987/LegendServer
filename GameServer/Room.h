...
public:
	...
	void SetObjectInfo(OUT ObjectInfo& _objectInfo, uint64 _objectId, ObjectType _objectType, FactionType _factionType, LaneType _laneType, ObjectMove _objectMove);
